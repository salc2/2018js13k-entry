...
function orthographic(left:number, right:number, bottom:number, top:number, near:number, far:number) {
     const dst:Float32Array = new Float32Array(16);
    ...
    function translate(m:any, tx:any, ty:any, tz:any) {
    ...
    function scale(m:any, sx:any, sy:any, sz:any) {
    ...
    function translation(tx:any, ty:any, tz:any) {
    const dst = new Float32Array(16);
